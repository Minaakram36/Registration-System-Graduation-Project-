import 'package:registrationsystem/admin_screen/course.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:flutter/material.dart';

class rsearchstudent extends StatefulWidget {
  const rsearchstudent({Key? key}) : super(key: key);

  @override
  State<rsearchstudent> createState() => _rsearchstudent();
}

class _rsearchstudent extends State<rsearchstudent> {
