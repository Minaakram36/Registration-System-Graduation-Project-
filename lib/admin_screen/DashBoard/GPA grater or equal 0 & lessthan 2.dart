...
class GPAgraterorequal0andlessthan2 extends StatelessWidget {
      ...
      builder: (_, sizingInformation) {
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Text("Students GPA equal to 0.0 and less than 2.0"),
          ),
          body: Column(
            children: [
              Expanded(
                child: StreamBuilder(
                    stream: FirebaseFirestore.instance
                        .collection('Users')
                        .where('GPA',
                            isGreaterThanOrEqualTo: 0, isLessThan: 2.0)
                        .snapshots(),
