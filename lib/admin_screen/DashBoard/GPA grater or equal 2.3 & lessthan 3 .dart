...
class GPAgraterorequal2point3andlessthan3 extends StatelessWidget {
      ...
      builder: (_, sizingInformation) {
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Text("Students GPA equal to 2.3 and less than 3.0"),
          ),
          body: Column(
            children: [
              Expanded(
                child: StreamBuilder(
                    stream: FirebaseFirestore.instance
                        .collection('Users')
                        .where('GPA',
                            isGreaterThanOrEqualTo: 2.3, isLessThan: 3.0)
                        .snapshots(),
