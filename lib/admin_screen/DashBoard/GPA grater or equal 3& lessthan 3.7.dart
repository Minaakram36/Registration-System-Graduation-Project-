...
class GPAgraterorequal3andlessthan3point7 extends StatelessWidget {
      ...
      builder: (_, sizingInformation) {
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Text("Students GPA equal to 3 and less than 3.7"),
          ),
          body: Column(
            children: [
              Expanded(
                child: StreamBuilder(
                    stream: FirebaseFirestore.instance
                        .collection('Users')
                        .where('GPA',
                            isGreaterThanOrEqualTo: 3, isLessThan: 3.7)
                        .snapshots(),
