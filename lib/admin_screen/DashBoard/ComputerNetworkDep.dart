...
class ComputerNetworkDep extends StatelessWidget {
      ...
      builder: (_, sizingInformation) {
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Text("Computer Network Students"),
          ),
          body: Column(
            children: [
              Expanded(
                child: StreamBuilder(
                    stream: FirebaseFirestore.instance
                        .collection('Users')
                        .where('Department', isEqualTo: 'Computer Network')
                        .snapshots(),
                      ...
                      return ListView.builder(
                          ...
                          itemBuilder: (ctx, index) {
                            return Card(
                              ...
                              trailing:
                                  Text('Level 4 - Computer Network Major'),
                            ));
                          });
                    }),
              ),
